...
const SYNONYMS: Record<string, string[]> = {
  ...
  postgres: ['postgresql'],
  psql: ['postgresql', 'useful commands (psql)'],
  mongodb: ['mongodb'],
  mongo: ['mongodb'],
  nosql: ['mongodb'],
  redis: ['redis'],
  ...
  next: ['next.js'],
  nextjs: ['next.js'],
  ssr: ['next.js', 'server vs client components'],
  ssg: ['next.js', 'static & dynamic rendering'],
  node: ['node.js'],
  nodejs: ['node.js'],
  'node.js': ['node.js'],
  npm: ['node.js', 'npm scripts & nodemon', 'common npm packages', 'package management'],
  ...
  py: ['python'],
  pandas: ['pandas'],
  dataframe: ['pandas', 'creating dataframes & series'],
  'data frame': ['pandas'],
  numpy: ['numpy'],
  ndarray: ['numpy', 'creating arrays'],
  go: ['go'],
  golang: ['go'],
  kotlin: ['kotlin'],
  rust: ['rust'],
  ...
  jquery: ['jquery'],
  docker: ['docker'],
  container: ['docker', 'running containers'],
  containers: ['docker'],
  dockerfile: ['dockerfile'],
  compose: ['docker compose'],
  'docker compose': ['docker compose'],
  git: ['git version control'],
  github: ['github-specific workflow'],
  ...
  when: ['conditionals'],
  guard: ['conditionals', 'guards'],
  'if statement': ['conditionals'],
  branching: ['conditionals', 'branches'],
  ...
  func: ['functions'],
  fn: ['functions'],
  method: ['functions', 'methods (functions)', 'methods'],
  arrow: ['functions'],
  'arrow function': ['functions'],
  lambda: ['functions', 'blocks, procs & lambdas'],
  callback: ['functions'],
  closure: ['functions', 'closures & higher-order functions'],
  closures: ['functions', 'closures & higher-order functions'],
  return: ['functions'],
  parameter: ['functions'],
  argument: ['functions'],
  iife: ['functions'],
  generator: ['functions'],
  yield: ['functions'],
  higher: ['functions', 'closures & higher-order functions'],
  'higher order': ['functions', 'closures & higher-order functions'],
  currying: ['functions'],
  overload: ['functions'],
  'default parameter': ['functions'],
  'rest parameter': ['functions'],
  spread: ['functions', 'objects'],
  variadic: ['functions'],
  ...
  class: ['classes'],
  oop: ['classes', 'classes & oop', 'classes & objects'],
  'object oriented': ['classes', 'classes & oop'],
  inheritance: ['classes'],
  constructor: ['classes'],
  extends: ['classes'],
  super: ['classes'],
  ...
  setter: ['classes'],
  abstract: ['classes'],
  interface: ['interfaces', 'interfaces & functional interfaces'],
  trait: ['traits'],
  protocol: ['protocols'],
  mixin: ['tables as objects (oop)'],
  struct: ['structs'],
  enum: ['enums'],
  enums: ['enums'],
  sealed: ['classes'],
  data_class: ['classes & objects'],
  record: ['records (c# 9+)', 'records & pattern matching (dart 3+)'],
  singleton: ['classes', 'common patterns'],
  ...
  try: ['error handling', 'exception handling'],
  catch: ['error handling', 'exception handling'],
  throw: ['error handling', 'exception handling'],
  finally: ['error handling', 'exception handling'],
  error: ['error handling', 'exception handling'],
  ...
  async: ['promises', 'async/await', 'async programming'],
  await: ['promises', 'async/await'],
  promise: ['promises', 'async/await', 'then'],
  resolve: ['promises', 'async/await'],
  reject: ['promises', 'async/await'],
  fetch: ['promises', 'async/await', 'fetching data (api calls)'],
  ajax: ['promises', 'async/await', 'ajax'],
  ...
  goroutine: ['goroutines & channels'],
  channel: ['goroutines & channels'],
  coroutine: ['coroutines'],
  future: ['async programming'],
  observable: ['observables & rxjs'],
  rxjs: ['observables & rxjs'],
  stream: ['streams', 'streams (java 8+)'],
  'async await': ['promises', 'async/await'],
  concurrent: ['goroutines & channels'],
  parallel: ['goroutines & channels'],
  'event loop': ['promises'],
  microtask: ['promises'],
  ...
  boolean: ['data types'],
  bool: ['data types'],
  null: ['data types', 'nullable reference types'],
  undefined: ['data types'],
  nullable: ['null safety', 'nullable reference types'],
  'null safety': ['null safety'],
  optional: ['optionals', 'optional'],
  any: ['data types', 'basic types'],
  unknown: ['basic types'],
  void: ['basic types'],
  ...
  literal: ['strings'],
  concatenate: ['strings', 'combining & splitting arrays'],
  concat: ['strings'],
  trim: ['strings'],
  split: ['strings'],
  format: ['strings'],
  interpolation: ['strings', 'template syntax (interpolation)'],
  ...
  number: ['numbers', 'numbers & math'],
  num: ['numbers'],
  int: ['numbers'],
  integer: ['numbers'],
  float: ['numbers'],
  decimal: ['numbers'],
  math: ['numbers', 'mathematical functions', 'numbers & math'],
  round: ['numbers'],
  floor: ['numbers'],
  ceil: ['numbers'],
  random: ['numbers'],
  ...
  modulo: ['numbers'],
  exponent: ['numbers'],
  'math function': ['mathematical functions', 'numbers'],
  ...
  map: ['arrays', 'maps & sets', 'maps'],
  filter: ['arrays'],
  reduce: ['arrays'],
  find: ['arrays', 'sorting & searching', 'find documents'],
  includes: ['arrays'],
  ...
  tuple: ['basic types', 'tuples'],
  stack: ['arrays'],
  queue: ['arrays'],
  deque: ['arrays'],
  'array method': ['arrays'],
  flatten: ['arrays'],
  'array slicing': ['array indexing & slicing'],
  'list comprehension': ['list/dict comprehensions'],
  'dict comprehension': ['list/dict comprehensions'],
  ...
  object: ['objects', 'classes & objects'],
  obj: ['objects'],
  dict: ['objects', 'hashes', 'dictionaries'],
  dictionary: ['objects', 'hashes', 'dictionaries'],
  hash: ['objects', 'hashes', 'hashmaps'],
  hashmap: ['hashmaps'],
  ...
  set: ['maps & sets', 'sets', 'set operations'],
  weakmap: ['maps & sets'],
  weakset: ['maps & sets'],
  'sorted set': ['sorted sets'],
  json: ['json', 'json handling', 'json & jsonb'],
  parse: ['json'],
  stringify: ['json'],
  serialize: ['json'],
  deserialize: ['json'],
  ...
  import: ['modules', 'modules & imports', 'packages & imports'],
  export: ['modules'],
  module: ['modules', 'modules (commonjs)', 'modules (es modules)'],
  require: ['modules', 'modules (commonjs)'],
  package: ['package.json', 'packages & imports'],
  namespace: ['packages & imports'],
  commonjs: ['modules (commonjs)'],
  esm: ['modules (es modules)'],
  'es module': ['modules (es modules)'],
  ...
  pattern: ['regular expressions', 'common patterns'],
  ...
  event: ['dom manipulation', 'event handling', 'events'],
  click: ['dom manipulation', 'event handling'],
  listener: ['dom manipulation', 'event handling'],
  'event listener': ['dom manipulation', 'event handling'],
  query: ['dom manipulation', 'querysets (orm)', 'find documents'],
  ...
  remove: ['dom manipulation', 'removing elements', 'delete documents'],
  traverse: ['traversing dom'],
  append: ['dom manipulation', 'creating & inserting elements'],
  ...
  stash: ['stashing'],
  pull: ['push & pull'],
  remote: ['remote repositories', 'push & pull'],
  ...
  diff: ['comparing changes (diff)'],
  stage: ['staging changes'],
  conflict: ['working with conflicts'],
  'cherry pick': ['cherry pick'],
  cherrypick: ['cherry pick'],
  submodule: ['submodules'],
  alias: ['aliases', 'aliases & shell customization'],
  workflow: ['basic workflow', 'common workflow example', 'github-specific workflow'],
  blame: ['viewing history'],
  amend: ['committing changes'],
  squash: ['rebasing'],
  fork: ['github-specific workflow'],
  'pull request': ['github-specific workflow'],
  pr: ['github-specific workflow'],
  'git log': ['viewing history'],
  'git diff': ['comparing changes (diff)'],
  ...
  'git rebase': ['rebasing'],
  'git stash': ['stashing'],
  'git clone': ['creating a repository'],
  'git init': ['creating a repository'],
  'git tag': ['tags'],
  'git reset': ['undoing changes'],
  'git revert': ['undoing changes'],
  'working tree': ['staging changes'],
  'staging area': ['staging changes'],

  // ═══════════════════════════════════════════════════════════
  // CSS / STYLING
  // ═══════════════════════════════════════════════════════════

  flex: ['flexbox', 'display & flexbox utilities'],
  flexbox: ['flexbox'],
  ...
  responsive: ['responsive design', 'dimensions & responsive design'],
  ...
  overflow: ['sizing overflow', 'sizing utilities'],
  position: ['position property'],
  display: ['display property', 'display & flexbox utilities'],
  border: ['borders', 'box model', 'border utilities'],
  'border radius': ['borders'],
  shadow: ['shadows'],
  'box shadow': ['shadows'],
  background: ['background properties', 'colors & backgrounds'],
  gradient: ['background properties'],
  font: ['fonts', 'typography'],
  'font size': ['fonts', 'typography'],
  'font weight': ['fonts'],
  color: ['colors', 'colors & backgrounds'],
  unit: ['units'],
  'custom property': ['variables (custom properties)'],
  'css variable': ['variables (custom properties)'],
  animation: ['animations', 'basic animation'],
  keyframe: ['animations'],
  ...
  select: ['select — read data', 'select data'],
  'select data': ['select data', 'select — read data'],
  'insert data': ['insert — add data', 'insert data'],
  update: ['update — modify data', 'update data'],
  delete: ['delete — remove data', 'delete data'],
  where: ['where — filter data', 'where clause'],
  'inner join': ['joins'],
  'left join': ['joins'],
  'right join': ['joins'],
  'outer join': ['joins'],
  'order by': ['order by — sort results', 'order by'],
  orderby: ['order by — sort results'],
  'group by': ['aggregate functions', 'group by'],
  groupby: ['aggregate functions', 'groupby'],
  ...
  privilege: ['users and privileges'],
  permission: ['users and privileges', 'file permissions'],
  distinct: ['select — read data'],
  limit: ['select — read data', 'select data'],
  offset: ['select — read data'],
  ...
  jsx: ['jsx syntax'],
  tsx: ['jsx syntax'],
  usestate: ['state with usestate'],
  useeffect: ['useeffect hook'],
  useref: ['useref hook'],
  usecontext: ['usecontext hook'],
  usememo: ['usememo & usecallback'],
  usecallback: ['usememo & usecallback'],
  'custom hook': ['custom hooks'],
  'react hook': ['custom hooks'],
  hook: ['lifecycle hooks', 'custom hooks'],
  lifecycle: ['lifecycle hooks', 'component lifecycle (with hooks)'],
  context: ['usecontext hook'],
  'react router': ['react router'],
  'controlled input': ['forms & controlled inputs'],
  keys: ['lists & keys'],
  'list rendering': ['list rendering', 'lists & keys'],
  'conditional rendering': ['conditional rendering'],
  memo: ['usememo & usecallback'],
  ref: ['useref hook', 'refs (dom access)'],
  'react state': ['state with usestate'],
  'react props': ['basic component'],
  'react form': ['forms & controlled inputs'],
  'react list': ['lists & keys'],
  ...
  reactivity: ['data & reactivity (options api)'],
  directive: ['directives'],
  'v-model': ['forms & v-model'],
  vmodel: ['forms & v-model'],
  'v-if': ['conditional rendering'],
  'v-for': ['list rendering'],
  'v-bind': ['directives', 'class & style binding'],
  'v-on': ['directives', 'event handling'],
  'composition api': ['composition api (modern way)'],
  'options api': ['data & reactivity (options api)'],
  pinia: ['pinia (state management)'],
  vuex: ['pinia (state management)'],
  store: ['pinia (state management)'],
  state: ['pinia (state management)', 'state with usestate'],
  'vue router': ['vue router (navigation)'],
  router: ['vue router (navigation)', 'routing'],
  route: ['routing', 'vue router (navigation)'],
  navigate: ['navigation', 'routing'],
  navigation: ['navigation', 'routing', 'vue router (navigation)'],
  'vue emit': ['emits (child to parent)'],
  'vue slot': ['slots'],
  'vue prop': ['props'],
  teleport: ['component registration'],
  'vue lifecycle': ['lifecycle hooks'],
  'vue computed': ['computed properties'],
  'vue watcher': ['watchers'],
  ...
  elementref: ['viewchild & elementref'],
  'data binding': ['data binding'],
  binding: ['data binding', 'class & style binding'],
  'template driven': ['forms (template-driven)'],
  'reactive form': ['forms (reactive)'],
  'http client': ['http client'],
  'ng-content': ['content projection (ng-content)'],
  'content projection': ['content projection (ng-content)'],
  'angular service': ['services'],
  'angular guard': ['guards'],
  'angular module': ['components'],
  'angular pipe': ['pipes'],
  'angular directive': ['directives'],
  'angular component': ['components'],
  'angular interceptor': ['interceptors'],
  'angular form': ['forms (template-driven)', 'forms (reactive)'],
  'angular cli': ['angular cli commands'],
  'ng generate': ['angular cli commands'],
  ...
  'file system': ['file system (fs)', 'file & directory operations'],
  fs: ['file system (fs)', 'file handling'],
  path: ['path module'],
  'http server': ['http server (built-in)'],
  'event emitter': ['events (eventemitter)'],
  eventemitter: ['events (eventemitter)'],
  process: ['process & os'],
  nodemon: ['npm scripts & nodemon'],
  'npm script': ['npm scripts & nodemon'],
  mongoose: ['mongodb with mongoose'],
  multer: ['file uploads (multer)', 'file uploads'],
  'node stream': ['streams'],
  'node event': ['events (eventemitter)'],
  'node module': ['modules (commonjs)', 'modules (es modules)'],
  'node http': ['http server (built-in)'],
  'node process': ['process & os'],
  'node path': ['path module'],
  'node fs': ['file system (fs)'],
  ...
  'express route': ['basic routing'],
  'express middleware': ['express middleware', 'middleware'],
  'express router': ['express router'],
  'express request': ['express request & response'],
  'express response': ['express request & response', 'response methods'],
  'express static': ['serving static files'],
  'template engine': ['template engines'],
  'view engine': ['template engines'],
  ...
  jwt: ['jwt authentication', 'authentication (jwt example)'],
  'bearer token': ['jwt authentication'],
  oauth: ['authentication'],
  session: ['sessions & cookies', 'sessions & flash messages'],
  ...
  rest: ['rest api patterns', 'rest api example'],
  restful: ['rest api patterns'],
  endpoint: ['rest api', 'route handlers (api routes)', 'basic routing'],
  middleware: ['middleware'],
  server: ['setup', 'rest api example', 'http server (built-in)'],
  'server action': ['server actions'],
  'api route': ['route handlers (api routes)'],
  webhook: ['rest api patterns'],
  'rest api': ['rest api patterns', 'rest api example'],
  'api endpoint': ['basic routing', 'route handlers (api routes)'],
  'api request': ['request object', 'request & response'],
  'api response': ['response methods', 'response handling'],
  'status code': ['response methods', 'response handling'],
  'http method': ['rest api patterns', 'basic routing'],
  'get request': ['rest api patterns'],
  'post request': ['rest api patterns'],
  'put request': ['rest api patterns'],
  'delete request': ['rest api patterns'],
  'patch request': ['rest api patterns'],
  ...
  eloquent: ['eloquent models', 'eloquent queries'],
  artisan: ['artisan commands'],
  seeder: ['seeders & factories'],
  factory: ['seeders & factories'],
  relationship: ['relationships'],
  'has many': ['relationships'],
  'belongs to': ['relationships'],
  'has one': ['relationships'],
  'many to many': ['relationships'],
  facade: ['common helper functions'],
  helper: ['common helper functions'],
  flash: ['sessions & flash messages', 'flash messages'],
  'laravel route': ['routing'],
  'laravel controller': ['controllers'],
  'laravel model': ['eloquent models'],
  'laravel migration': ['migrations'],
  'laravel validation': ['validation'],
  'laravel middleware': ['middleware'],
  'laravel auth': ['authentication'],
  'laravel blade': ['blade templates'],
  'laravel eloquent': ['eloquent models', 'eloquent queries'],
  'laravel seeder': ['seeders & factories'],
  'laravel artisan': ['artisan commands'],
  'laravel session': ['sessions & flash messages'],
  ...
  'flask form': ['flask-wtf (form validation)'],
  sqlalchemy: ['database (flask-sqlalchemy)'],
  'flask migrate': ['flask-migrate'],
  'flask restful': ['flask-restful / flask-cors'],
  queryset: ['querysets (orm)'],
  ...
  'function based view': ['views (function-based)'],
  'django model': ['models'],
  'django view': ['views (function-based)', 'views (class-based)'],
  'django url': ['urls'],
  'django admin': ['admin panel'],
  'django auth': ['user authentication'],
  'django signal': ['signals'],
  'django migration': ['migrations'],
  'django static': ['static & media files'],
  'flask route': ['basic routing', 'routing'],
  'flask template': ['templates (jinja2)'],
  'flask db': ['database (flask-sqlalchemy)'],
  'flask api': ['rest api patterns'],
  'flask blueprint': ['blueprints'],
  'flask config': ['application context & config'],

  // ═══════════════════════════════════════════════════════════
  // DATABASE & ORM
  // ═══════════════════════════════════════════════════════════

  database: ['database', 'database & collection basics'],
  db: ['database'],
  model: ['models', 'entity (jpa model)', 'eloquent models'],
  ...
  profile: ['profiles'],
  'env variable': ['environment variables', 'environment configuration'],
  ...
  write: ['file handling', 'reading & writing data'],
  directory: ['file & directory operations'],
  folder: ['file & directory operations'],
  'file read': ['file handling', 'file system (fs)'],
  'file write': ['file handling', 'file system (fs)'],
  'file upload': ['file uploads', 'file uploads (multer)'],
  'read file': ['file handling', 'file system (fs)'],
  'write file': ['file handling', 'file system (fs)'],
  ...
  controller: ['rest controllers', 'controllers'],
  'rest controller': ['rest controllers'],
  entity: ['entity (jpa model)', 'special characters'],
  jpa: ['entity (jpa model)', 'repository (spring data jpa)'],
  ...
  logging: ['logging'],
  'request mapping': ['request mapping annotations'],
  '@getmapping': ['request mapping annotations'],
  '@postmapping': ['request mapping annotations'],
  '@restcontroller': ['rest controllers'],
  '@entity': ['entity (jpa model)'],
  '@repository': ['repository (spring data jpa)'],
  '@service': ['service layer'],
  '@autowired': ['dependency injection'],
  'spring jwt': ['jwt authentication'],
  'spring auth': ['spring security'],
  'spring config': ['configuration properties'],
  'spring profile': ['profiles'],
  'spring logging': ['logging'],
  'spring test': ['testing'],
  ...
  layout: ['layouts', 'grid layout', 'flexbox layout'],
  page: ['pages & routing (app router)'],
  render: ['server vs client components', 'static & dynamic rendering'],
  'data fetching': ['data fetching'],
  swr: ['client-side data fetching (swr)'],
  'app router': ['pages & routing (app router)'],
  'server component': ['server vs client components'],
  'client component': ['server vs client components'],
  metadata: ['metadata & seo', 'meta tags'],
  loading: ['loading & error states'],
  'next layout': ['layouts'],
  'next page': ['pages & routing (app router)'],
  'next api': ['route handlers (api routes)'],
  'next font': ['fonts'],
  'next image': ['static assets'],
  'next metadata': ['metadata & seo'],
  'next ssr': ['server vs client components'],
  'next ssg': ['static & dynamic rendering'],
  'use client': ['server vs client components'],
  ...
  image: ['images', 'working with images', 'building images'],
  'docker image': ['working with images'],
  'docker container': ['running containers'],
  volume: ['volumes'],
  network: ['networks', 'networking'],
  registry: ['registry & pushing images'],
  'docker build': ['building images'],
  'docker run': ['running containers'],
  'docker push': ['registry & pushing images'],
  cleanup: ['cleaning up'],
  prune: ['cleaning up'],
  'docker volume': ['volumes'],
  'docker network': ['networks'],
  'docker ps': ['managing containers'],
  'docker exec': ['executing commands in containers'],
  'docker inspect': ['inspecting containers'],
  'docker logs': ['inspecting containers'],
  'docker stop': ['managing containers'],
  'docker rm': ['managing containers'],
  'docker rmi': ['cleaning up'],
  'docker pull': ['working with images'],
  ...
  'bs grid': ['grid system'],
  'bs flex': ['display & flexbox utilities'],
  tab: ['tabs'],
  ...
  'jquery selector': ['selectors'],
  'jquery event': ['events'],
  'jquery animation': ['effects & animation'],
  'jquery ajax': ['ajax'],
  chaining: ['chaining'],
  effect: ['effects & animation'],
  'jquery dom': ['dom manipulation'],
  'jquery form': ['form handling'],

  // ═══════════════════════════════════════════════════════════
  // PYTHON
  // ═══════════════════════════════════════════════════════════

  pip: ['setup', 'package management'],
  venv: ['setup'],
  virtualenv: ['setup'],
  builtin: ['common built-in functions'],
  'built-in': ['common built-in functions'],
  datetime: ['working with dates', 'date and time'],
  unpacking: ['working with multiple values'],
  decorator: ['classes & oop'],
  'python list': ['arrays', 'lists'],
  'python dict': ['dictionaries'],
  'python set': ['sets'],
  'python tuple': ['tuples'],
  'python class': ['classes & oop'],
  'python function': ['functions'],
  'python loop': ['loops'],
  'python string': ['strings'],
  'python import': ['modules & imports'],
  ...
  'read csv': ['reading & writing data'],
  read_csv: ['reading & writing data'],
  loc: ['selecting data'],
  iloc: ['selecting data'],
  'missing data': ['handling missing data'],
  nan: ['handling missing data', 'nan & infinity handling'],
  dropna: ['handling missing data'],
  fillna: ['handling missing data'],
  'pivot table': ['pivot tables & reshaping'],
  pivot: ['pivot tables & reshaping'],
  melt: ['pivot tables & reshaping'],
  'pandas merge': ['merging & joining'],
  duplicate: ['duplicate handling'],
  dtype: ['data types & conversion'],
  'pandas groupby': ['groupby'],
  'pandas sort': ['sorting & ranking'],
  'pandas filter': ['selecting data'],
  'pandas apply': ['modifying data'],
  'pandas concat': ['merging & joining'],
  describe: ['aggregation & statistics'],
  'head tail': ['viewing data'],
  'value counts': ['aggregation & statistics'],
  'reset index': ['modifying data'],
  'rename column': ['modifying data'],
  'drop column': ['modifying data'],
  ...
  'element wise': ['array operations (element-wise)'],
  'numpy array': ['creating arrays'],
  'numpy math': ['mathematical functions'],
  arange: ['creating arrays'],
  linspace: ['creating arrays'],
  zeros: ['creating arrays'],
  ones: ['creating arrays'],
  'numpy sort': ['sorting & searching'],
  vstack: ['combining & splitting arrays'],
  hstack: ['combining & splitting arrays'],
  'numpy nan': ['nan & infinity handling'],
  ...
  aggregation: ['aggregation pipeline', 'aggregation & statistics'],
  pipeline: ['aggregation pipeline'],
  'text search': ['text search'],
  'schema design': ['schema design (embedding vs referencing)'],
  embedding: ['schema design (embedding vs referencing)'],
  referencing: ['schema design (embedding vs referencing)'],
  'native driver': ['node.js mongodb driver (native)'],
  ...
  pub: ['pub/sub', 'package management'],
  subscribe: ['pub/sub'],
  'pub sub': ['pub/sub'],
  pubsub: ['pub/sub'],
  expire: ['expiration & ttl'],
  ttl: ['expiration & ttl'],
  'key naming': ['key naming conventions'],
  ...
  linq: ['linq'],
  delegate: ['classes'],
  'nullable types': ['nullable reference types'],
  records: ['records (c# 9+)'],
  'csharp async': ['async/await'],
  'csharp generic': ['generics'],
  annotation: ['entity (jpa model)', 'request mapping annotations'],
  maven: ['setup', 'package management'],
  gradle: ['setup', 'package management'],
  'java stream': ['streams (java 8+)'],
  'java optional': ['optional'],
  'functional interface': ['interfaces & functional interfaces'],
  defer: ['functions'],
  'go interface': ['interfaces'],
  'go struct': ['structs'],
  'go goroutine': ['goroutines & channels'],
  'go channel': ['goroutines & channels'],
  'go slice': ['arrays & slices'],
  'go map': ['maps'],
  'go error': ['error handling'],
  'go json': ['json handling'],
  'go http': ['http server'],
  'go package': ['packages & imports'],
  'kotlin coroutine': ['coroutines'],
  'scope function': ['scope functions'],
  'null check': ['null safety'],
  'elvis operator': ['null safety'],
  'data class': ['classes & objects'],
  ownership: ['ownership & borrowing'],
  borrow: ['ownership & borrowing'],
  borrowing: ['ownership & borrowing'],
  lifetime: ['ownership & borrowing'],
  'rust trait': ['traits'],
  iterator: ['iterators & closures'],
  cargo: ['setup', 'package management'],
  'rust struct': ['structs'],
  'rust match': ['conditionals'],
  'swift optional': ['optionals'],
  'swift protocol': ['protocols'],
  'swift class': ['classes'],
  'swift struct': ['structs'],
  'swift enum': ['enums'],
  'swift closure': ['closures & higher-order functions'],
  widget: ['dart', 'core components'],
  'dart async': ['async programming'],
  'dart future': ['async programming'],
  gem: ['setup', 'package management'],
  'ruby block': ['blocks, procs & lambdas'],
  proc: ['blocks, procs & lambdas'],
  'ruby hash': ['hashes'],
  'lua table': ['tables as objects (oop)'],
  metatables: ['tables as objects (oop)'],

  // ═══════════════════════════════════════════════════════════
  // REACT NATIVE
  // ═══════════════════════════════════════════════════════════

  flatlist: ['lists (flatlist & sectionlist)'],
  sectionlist: ['lists (flatlist & sectionlist)'],
  ...
  touchable: ['buttons & touchables'],
  'react native style': ['styling'],
  'react native flex': ['flexbox layout'],
  'react native nav': ['navigation (react navigation)'],
  'react native list': ['lists (flatlist & sectionlist)'],
  'react native image': ['images & icons'],
  'react native button': ['buttons & touchables'],
  ...
  ls: ['navigation', 'file & directory operations'],
  cd: ['navigation'],
  mkdir: ['file & directory operations'],
  rm: ['file & directory operations'],
  cp: ['file & directory operations'],
  mv: ['file & directory operations'],
  grep: ['searching', 'text processing'],
  chmod: ['file permissions'],
  chown: ['file permissions'],
  ps: ['process management'],
  kill: ['process management'],
  top: ['process management', 'server & monitoring commands'],
  ssh: ['networking'],
  curl: ['networking'],
  wget: ['networking'],
  ping: ['networking'],
  ...
  zip: ['archives & compression'],
  unzip: ['archives & compression'],
  ...
  head: ['viewing file contents'],
  tail: ['viewing file contents'],
  nano: ['file editing (nano & vim basics)'],
  vim: ['file editing (nano & vim basics)'],
  vi: ['file editing (nano & vim basics)'],
  systemctl: ['system services (systemd)'],
  service: ['system services (systemd)'],
  useradd: ['user management'],
  passwd: ['user management'],
  df: ['disk & system info'],
  du: ['disk & system info'],
  echo: ['redirection & pipes'],
  'pipe operator': ['redirection & pipes'],
  xargs: ['redirection & pipes'],
  cron: ['system services (systemd)'],
  'cron job': ['system services (systemd)'],
  'list files': ['file & directory operations', 'navigation'],
  'change directory': ['navigation'],
  'search file': ['searching'],
  'find file': ['searching'],
  'linux permission': ['file permissions'],
  'process list': ['process management'],
  'kill process': ['process management'],
  'check disk': ['disk & system info'],
  compress: ['archives & compression'],
  ...
  heading: ['headings'],
  link: ['links'],
  form: ['forms', 'forms & v-model', 'forms & validation'],
  input: ['input types', 'forms', 'text input'],
  table: ['tables'],
  ...
  'ts generic': ['generics'],
  'ts enum': ['enums'],
  'ts type': ['type aliases', 'basic types'],
  'ts utility': ['utility types'],
  ...
  animate: ['basic animation', 'animate prop'],
  'initial animate': ['initial & animate'],
  exit: ['exit animations'],
  'exit animation': ['exit animations'],
  scroll: ['scroll animations'],
  'animation control': ['animation controls'],
  'motion value': ['usemotionvalue & usetransform'],
  'hover animation': ['hover & tap'],
  'tap animation': ['hover & tap'],
  'arbitrary value': ['custom values (arbitrary values)'],
  test: ['testing'],
  unittest: ['testing'],
  'unit test': ['testing'],
  mock: ['testing'],
  deploy: ['setup', 'static & dynamic rendering'],
  build: ['setup', 'building images'],
  'project structure': ['project structure'],
  scaffold: ['setup', 'project structure'],
  boilerplate: ['setup', 'basic structure'],
  'design pattern': ['common patterns'],
  observer: ['signals', 'observables & rxjs'],
  mvc: ['controllers', 'views (function-based)'],
  mvvm: ['data binding'],
  'getting started': ['setup'],
  beginner: ['setup', 'basic syntax'],
  basics: ['basic syntax', 'basic structure'],
  example: ['common patterns', 'rest api example', 'common workflow example'],
  'cheat sheet': ['common patterns'],
  'best practice': ['common patterns'],
    ...
    <Transition name="mobile-search">
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto no-scrollbar">
          ...
          >
            <div
              class="w-14 h-14 rounded-full bg-neutral-gray/20 flex items-center justify-center mb-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <template v-else>
            ...
            <div v-if="sectionResults.length > 0">
              <div
                ...
                :class="
                  topicResults.length > 0 ? 'pt-5 border-t border-neutral-gray/50 mt-2' : 'pt-5'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
